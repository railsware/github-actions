...
const shared_ini_file_loader_1 = __webpack_require__(7831);
const node_fs_1 = __webpack_require__(7561);
const fromWebToken_1 = __webpack_require__(4619);
...
const fromWebToken = (init) => async (awsIdentityProperties) => {
    ...
    if (!roleAssumerWithWebIdentity) {
        const { getDefaultRoleAssumerWithWebIdentity } = await Promise.resolve().then(() => __importStar(__webpack_require__(6448)));
...
var fromTokenFile = __webpack_require__(5701);
var fromWebToken = __webpack_require__(4619);

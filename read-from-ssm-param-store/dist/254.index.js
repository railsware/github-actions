...
var propertyProvider = __webpack_require__(7879);
var sharedIniFileLoader = __webpack_require__(7831);
var client = __webpack_require__(7850);
var tokenProviders = __webpack_require__(7179);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(6868); });
    const sso = ssoClient ||
...
var sso = __webpack_require__(8684);
...
const bdd_1 = __webpack_require__(1014);
...
var middlewareHostHeader = __webpack_require__(2459);
var middlewareLogger = __webpack_require__(1475);
var middlewareRecursionDetection = __webpack_require__(4103);
var middlewareUserAgent = __webpack_require__(7163);
var configResolver = __webpack_require__(1818);
var core = __webpack_require__(1422);
var schema = __webpack_require__(6958);
var middlewareContentLength = __webpack_require__(1829);
var middlewareEndpoint = __webpack_require__(2538);
var middlewareRetry = __webpack_require__(7273);
var smithyClient = __webpack_require__(1866);
var httpAuthSchemeProvider = __webpack_require__(7117);
var runtimeConfig = __webpack_require__(2235);
var regionConfigResolver = __webpack_require__(1945);
var protocolHttp = __webpack_require__(4117);
var schemas_0 = __webpack_require__(9256);
var errors = __webpack_require__(2439);
var SSOServiceException = __webpack_require__(5125);
...
const SSOServiceException_1 = __webpack_require__(5125);
...
const runtimeConfig_shared_1 = __webpack_require__(8075);
...
const httpAuthSchemeProvider_1 = __webpack_require__(7117);
const endpointResolver_1 = __webpack_require__(6410);
const schemas_0_1 = __webpack_require__(9256);
const getRuntimeConfig = (config) => {
    return {
...
var client = __webpack_require__(7850);
var httpAuthSchemes = __webpack_require__(5749);
var propertyProvider = __webpack_require__(7879);
var sharedIniFileLoader = __webpack_require__(7831);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 136).then(__webpack_require__.t.bind(__webpack_require__, 5136, 23));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 136).then(__webpack_require__.t.bind(__webpack_require__, 5136, 23));
